...
review round (`docs/reviews/2026-09-06-round{10,…,22}/`; rounds 13–17 re-reviewed each fix commit until
both reviewers approved with no finding; rounds 18–22 reviewed the localisation). ADR-0007 records the design.

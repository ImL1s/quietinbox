...
| Design system | Avatar monograms | `MonogramTest` (4: Han, kana and hangul names give one glyph, Latin names two initials, blank gives `?`) | `./gradlew :core:designsystem:testDebugUnitTest` |

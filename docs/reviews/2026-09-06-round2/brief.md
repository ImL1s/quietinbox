...
## What to review
Repository: <repo>, branch main. Review the diff of the fix commit
`git diff 3ef8fb8..8050e05` (37 files) in the context of the whole codebase. Round-1 reports are in
`docs/reviews/2026-09-06-round1/gemini-3.8-flash-high.md`, `dual-review-subagent.md`, `dual-review-fable.md`; every Critical/Important
...
Hard product rules are the same nine listed in `docs/reviews/2026-09-06-round1/brief.md`.
